...
if __name__ == '__main__':
    ...
    try:
         t = 0
         while t < 200:
             strip.setPixelColor(x[t], Color(random_color(),random_color(),random_color()))
             strip.show()
             t = t+1
         ...
         while True:
             ...
             t = 0
             while t < 200:
                 strip.setPixelColor(x[random.randrange(0,199)], Color(random_color(),random_color(),random_color()))
                 strip.show()
                 t = t+1
                 time.sleep(0.01)
         list_a = []
